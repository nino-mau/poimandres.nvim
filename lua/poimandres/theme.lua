...
function M.get(config)
  ...
  theme = {
    ...
    BufferLineMiniIconsGreenSelected = { fg = p.blue2, bg = p.background1 },
    BufferLineMiniIconsBlueSelected = { fg = p.blue2, bg = p.background1 },
    BufferLineMiniIconsWhiteSelected = { fg = p.blue2, bg = p.background1 },
    BufferLineMiniIconsGreySelected = { fg = p.blue2, bg = p.background1 },
    BufferLineMiniIconsGraySelected = { fg = p.blue2, bg = p.background1 },
    ...
    BufferLineMiniIconsGreen = { fg = p.blue2, bg = p.background2 },
    BufferLineMiniIconsWhite = { fg = p.blue2, bg = p.background2 },
    BufferLineMiniIconsGray = { fg = p.blue2, bg = p.background2 },
    BufferLineMiniIconsGrey = { fg = p.blue2, bg = p.background2 },
