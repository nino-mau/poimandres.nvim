...
function M.get(config)
  ...
  local styles = {
    ...
    border = (config.disable_background and p.blueGray3) or groups.border,
  ...
  theme = {
    ...
    BufferLineMiniIconsGreenSelected = { fg = p.teal1, bg = p.background1 },
    BufferLineMiniIconsBlueSelected = { fg = p.blue2, bg = p.background1 },
    BufferLineMiniIconsWhiteSelected = { fg = p.white, bg = p.background1 },
    BufferLineMiniIconsGreySelected = { fg = p.text, bg = p.background1 },
    BufferLineMiniIconsGraySelected = { fg = p.text, bg = p.background1 },
